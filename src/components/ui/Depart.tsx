...
export default function Depart({ ...field }) {
  return (
    <DatePicker
      {...field}
      ...
      <div className="flex">
        <Group className="w-full ">
          <DateInput className="h-14 w-[140px] bg-white rounded-none rounded-l-lg md:rounded-l-none border-r-2 border-r-gray-300" />
        </Group>
